...
export declare function createResourceState<T extends StateNode>(state: T | State<T>): [State<T>, LoadStateFunction<T>, SetStateFunction<T>];
...
export declare function suspend<T>(fn: () => T): () => T;
export {};
